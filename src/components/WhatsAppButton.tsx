const WhatsAppButton = () => {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 bg-green-500 text-white px-5 py-3 rounded-full shadow-lg flex items-center hover:bg-green-600 transition-all duration-300 hover:scale-105"
    >
      <svg
        aria-hidden="true"
